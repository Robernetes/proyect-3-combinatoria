...
import (
	"fmt"     //MODULO PARA ENTRADA Y SALIDA DE DATOS
	"os"      //MODULO PARA PROCESIMIENTOS CON EL SIST. OPERATIVO
	"os/exec" //MODULO PARA EJECUTAR COMANDOS DE LA TERMINAL
	"strconv" //MODULO PARA CONVERTIR TIPOS DE DATOS
	"time"    //MODULO PARA MANEJAR EL TIEMPO

	cp "github.com/Robernetes/proyect-3-combinatoria/combinatoria" //MODULO PROPIO QUE CONTIENE LAS FUNCIONES DE COMBINATORIA
	"github.com/gookit/color"                                      //MODULO PARA IMPRIMIR COLORES EN LA TERMINAL
)
